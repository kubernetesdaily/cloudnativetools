        ...
        <div>
          <div>
            ...
            <div className="flex flex-col md:flex-row justify-center gap-5 mt-4">
              <Button text={"Submit an Entry"} link={"https://github.com/Jelsingeprajwal/Kubedaily-kubetools/blob/main/src/data/entries.js"} />
              <Button text={"Github"} link={"https://github.com/Jelsingeprajwal/Kubedaily-kubetools"} />
              <Button
